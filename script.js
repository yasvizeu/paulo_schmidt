...
const WEEKS = [
  {
    number: 1,
    title: "Scheduling",
    focus: "Apresentação profissional, agendamento de reuniões futuras e ensaio",

    pdfs: [
      { label: "Conteúdo", url: "https://drive.google.com/file/d/1amBsjKdW17wRZmLMsNfHHMqdPJvYlowN/view?usp=drivesdk" }
    ],
